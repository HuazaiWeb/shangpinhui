<template>
  ...
  <div class="type-nav">
    <div class="container">
      <!-- 事件委派|事件委托   将一级菜单和全部商品分类的移除事件委托给 它的父盒子div -->
      <div @mouseleave="leaveIndex" @mouseenter="enterShow">
        ...
        <transition name="sort">
          <div class="sort" v-show="show">
            <!-- @click="goSearch" 事件委派  将a标签中的事件委派给父盒子-->
...
export default {
  ...
  methods: {
    ...
    goSearch(event) {
      //最好的解决方案:编程式导航＋事件委派
      //利用事件委派存在一些问题: 1:点击一定是a标签2:I如何获取参数【1、2、3级分类的产品的名字】
      ...
      if (categoryname) {
        ...
        if(this.$route.params){
          location.parmas = this.$route.params
          // 路由跳转
