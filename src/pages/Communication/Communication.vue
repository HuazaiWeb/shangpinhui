...
import AttrsListenersTest from './AttrsListenersTest/AttrsListenersTest'
import ChildrenParentTest from './ChildrenParentTest/ChildrenParentTest'
import EventTest from './EventTest/EventTest'
import ModelTest from './ModelTest/ModelTest'
import ScopeSlotTest from './ScopeSlotTest/ScopeSlotTest'
import SyncTest from './SyncTest/SyncTest'
  export default {
    name: 'Communication',
    components:{
      AttrsListenersTest,
