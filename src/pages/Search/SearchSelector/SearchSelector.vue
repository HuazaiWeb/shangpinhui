  ...
  <div class="clearfix selector">
    <div class="type-wrap logo">
      ...
      <div class="value logos">
        <ul class="logo-list">
          <!-- 传递 trademark品牌信息 给父组件 -->
          <li v-for="trademark in trademarkList" :key="trademark.tmId" @click="tradmarkChange(trademark)">{{trademark.tmName}}</li>
        </ul>
      </div>
      <div class="ext">
