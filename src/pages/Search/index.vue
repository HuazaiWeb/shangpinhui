      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <!-- 品牌的面包屑  searchParams.trademark.split(':')[1] 这里分割字符串提出品牌的名字出来 split()分割出来的是一个数组 -->
        ...
        <div class="details clearfix">
            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOder('1')">
                  <a>综合<span v-show="isOne" class="iconfont" :class="{'icon-jiantou':isAsc,'icon-jiantou1':isDesc}"></span></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOder('2')">
                  <a>价格<span v-show="isTwo" class="iconfont" :class="{'icon-jiantou':isAsc,'icon-jiantou1':isDesc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="search in goodsList" :key="search.id">
                <div class="list-wrap">
                  <div class="p-img">
                    <!-- 因为里面包含变量，所以要用动态绑定 ： 使用模板字符串 -->
                    <!-- 传递params参数过去 id -->
                  ...
                  <div class="attr">
                    <a target="_blank" href="item.html" title="促销信息，下单即赠送三个月CIBN视频会员卡！【小米电视新品4A 58 火爆预约中】">{{search.title}}</a>
                  </div>
                  <div class="commit">
...
<script>
  ...
  export default {
    ...
    beforeMount() {
      ...
      this.searchParams.category3Id = this.$route.query.categor3Id;
      this.searchParams.categoryName = this.$route.categoryName;
